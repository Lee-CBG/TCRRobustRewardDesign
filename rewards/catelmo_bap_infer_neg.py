...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='./catelmo_bap_head_robust.pth',
    ...
    model.load_state_dict(torch.load("/home/hmei7/workspace/ablat/catelmo_reimpl_20M.pth", map_location='cpu'))
